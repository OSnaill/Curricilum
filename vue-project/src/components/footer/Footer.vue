  ...
  <footer class="bg-black p-[20px]">
    <div class="max-w-[1280px] m-auto text-white md:flex-row flex-col gap-[20px] flex justify-between p-[20px] flex-wrap items-center">
        <section class="flex flex-col p-[20px]">
          ...
          <p class="text-sm text-white">@: <span class="text-mint">osouquiere.boris@gmail.com</span> </p>
          <p class="text-sm text-white">tel:<span class="text-mint"> 06.33.53.86.11 </span></p>
        </section>
        <section class="flex flex-row gap-[20px] flex-wrap p-[20px]">
          <p class="text-white">
            Fait avec
          </p>
